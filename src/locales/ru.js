export default {
  ...
  home: {
    ...
    distribution: {
      ...
      body: 'Так как валюта не майнится, распространение Skycoin не похоже на распространение добываемых криптовалют. Вместо валюты, уходящей майнерам, новые Skycoin распределяются между вкладчиками, разработчиками и инвесторами. Распространение валюты Skycoin спроектировано таким образом, что она уходит в руки людей, строящих и вкладывающихся в экосистему, а не в руки майнеров.',
      link: 'Узнать о распространении',
    },
    roadmap: {
      heading: 'План работ',
